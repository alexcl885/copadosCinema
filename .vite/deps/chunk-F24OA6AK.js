...
var TextField = React3.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime3.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime3.jsxs)(TextFieldRoot, {
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    ownerState,
    ...other,
    children: [label != null && label !== "" && (0, import_jsx_runtime3.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime3.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children
    }) : InputElement, helperText && (0, import_jsx_runtime3.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
true ? TextField.propTypes = {
  ...
  slotProps: import_prop_types3.default.shape({
    formHelperText: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object]),
    htmlInput: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object]),
    input: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object]),
    inputLabel: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object]),
    select: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object])
  }),
  /**
  ...
  slots: import_prop_types3.default.shape({
    formHelperText: import_prop_types3.default.elementType,
    htmlInput: import_prop_types3.default.elementType,
    input: import_prop_types3.default.elementType,
    inputLabel: import_prop_types3.default.elementType,
    select: import_prop_types3.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
//# sourceMappingURL=chunk-F24OA6AK.js.map
